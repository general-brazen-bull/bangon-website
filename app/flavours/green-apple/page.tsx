      ...
      <section className="min-h-[60vh] bg-[#f5f5f5] flex items-center pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-6 md:px-12 w-full">
          ...
          >
            ...
            <span className="block text-[#95cb00]">APPLE</span>
          </motion.h1>
          ...
          >
            99 proof of sharp green apple punch. Twice distilled premium spirit with a crisp, tart finish that hits fast and clean.
          </motion.p>
        </div>
      </section>
            ...
            >
              ...
              <div className="space-y-6 mb-12">
                ...
                <div className="flex justify-between items-center border-b border-[#0a0a0a]/20 pb-4">
                  ...
                  <span className="text-lg text-[#0a0a0a]">Crisp, Tart With A Clean Finish</span>
                </div>
                <div className="flex justify-between items-center border-b border-[#0a0a0a]/20 pb-4">
              ...
              <p className="text-lg text-[#0a0a0a] mb-12">
                Bright, sharp, unforgettable. The green apple kick you expect, but cleaner, stronger, and built to hit harder. Super concentrated for maximum impact.
              </p>
